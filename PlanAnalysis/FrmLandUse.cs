...
{
    public partial class FrmLandUse : Form
    {
        private MyPluginEngine.IApplication hk;
        public FrmLandUse(MyPluginEngine.IApplication hook)
        {
            InitializeComponent();
            this.hk = hook;
            //不显示最大化最小化按钮
        ...
        private void btOk_Click(object sender, EventArgs e)
        {
            ...
            //更改数据源
            string defaultPath = System.IO.Directory.GetCurrentDirectory().ToString() + "\\Data\\PlanAnalysis\\林地土地冲突.mxd";//获取Debug路径
            string fileName;
        ...
        private void FrmLandUse_Load(object sender, EventArgs e)
        {
            ...
            txtOutput.Text = System.IO.Directory.GetCurrentDirectory().ToString() + "\\Data\\PlanAnalysis\\03林规土地\\林规土地冲突.shp";
        }
    }
}
