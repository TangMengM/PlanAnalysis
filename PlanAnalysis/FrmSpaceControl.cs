...
{
    public partial class FrmSpaceControl : Form
    {
        private MyPluginEngine.IApplication hk;
        public FrmSpaceControl(MyPluginEngine.IApplication hook)
        {
            InitializeComponent();
            this.hk = hook;
            //不显示最大化最小化按钮
        ...
        private void btOk_Click(object sender, EventArgs e)
        {
            ...
            //更改数据源
            string defaultPath = System.IO.Directory.GetCurrentDirectory().ToString() + "\\Data\\PlanAnalysis\\空间管制冲突.mxd";//获取Debug路径
            string fileName;
        ...
        private void FrmSpaceControl_Load(object sender, EventArgs e)
        {
            ...
            txtOutput.Text = System.IO.Directory.GetCurrentDirectory().ToString() + "\\Data\\PlanAnalysis\\05空间管制\\空间管制冲突.shp";
        }
    }
}
