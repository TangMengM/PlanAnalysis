...
{
    public partial class FrmForestry : Form
    {
        private MyPluginEngine.IApplication hk;
        public FrmForestry(MyPluginEngine.IApplication hook)
        {
            InitializeComponent();
            this.hk = hook;
            //不显示最大化最小化按钮
        ...
        private void btOk_Click(object sender, EventArgs e)
        {
            ...
            //更改数据源
            string defaultPath = System.IO.Directory.GetCurrentDirectory().ToString() + "\\Data\\PlanAnalysis\\林地建设冲突.mxd";//获取Debug路径
            string fileName;
        ...
        private void FrmForestry_Load(object sender, EventArgs e)
        {
            txtInput1.Text = System.IO.Directory.GetCurrentDirectory().ToString() + "\\Data\\PlanAnalysis\\林地.shp";
            txtInput2.Text = System.IO.Directory.GetCurrentDirectory().ToString() + "\\Data\\PlanAnalysis\\建设.shp";
            txtOutput.Text = System.IO.Directory.GetCurrentDirectory().ToString() + "\\Data\\PlanAnalysis\\04林地建设\\林地建设冲突.shp";
        }
    }
}
